...
$sql = "SELECT idClube, total, nome FROM v2_total_mes INNER JOIN v2_clube ON clube = idClube ORDER BY dia_base DESC, total DESC LIMIT 32";
$query = $pdo->query($sql);
...
$cont = 0;
$echo = "<div class=\"content-box-title\"><p class=\"left-title\">Ranking Sócio-Torcedor Mês</p><p class=\"right-title\">Fonte: futebolmelhor.com.br</p><div class=\"clear\"></div></div>";
